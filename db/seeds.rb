...
Trail.create(name: "Angel's Landing Trail", hiking: 1, backpacking: 1, latitude: 37.1620, longitude: -112.5701)
Trail.create(name: "China Camp Trail", hiking: 1, mountain_biking: 1, latitude: 37.5934, longitude: -112.2910)
Trail.create(name: "Potato Chip Rock", hiking: 1, latitude: 33.0093, longitude: -116.9742, description: "Very popular trail.")
